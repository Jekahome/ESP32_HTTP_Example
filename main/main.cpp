...
DMA_ATTR static module_HTTP *server_HTTP;
         static module_MQTT *client_MQTT;
...
/*void test_encrypt_decrypt(){
    ...
    char *src_enc = "hello world";
    char *res_enc = get_encrypt(src_enc);
    printf("RES:[%s]\n",res_enc);

    char *src_dec = "e03436a3d579363645f0d9";
    char *res_dec = get_decrypt(src_dec);
    printf("RES:[%s]\n",res_dec);
}*/
 ...
 */
    ...
    // MQTT client
    client_MQTT = new module_MQTT();
    client_MQTT->mqtt_app_start(MQTT_BROKER_URL,MQTT_BROKER_AUTH_USERNAME,MQTT_BROKER_AUTH_PASSWORD);
